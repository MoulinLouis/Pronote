...
if($_GET) {
    $value=new classe_management();
    $result = $value->getClasse($_GET['id_classe']);
...
?>
    ...
    <div class="offset-2 col-md-8 col-xs-2">
        <div class="form-area text-center">
            <form id="form-contact" method="POST" action="/pronote/traitement/classe/modifierclasse-traitement.php">
                <br>
                <h3 style="margin-bottom: 25px; text-align: center;">Modification de la classe</h3>
                <div class="form-group">
                    <input type="text" name="classe" class="form-control" value="<?php echo $result['nom_classe']; ?>">
                </div>
