...
?>
    ...
    <div class="offset-2 col-md-8 col-xs-2">
        <div class="form-area text-center">
            <form id="form-contact" method="POST" action="/pronote/traitement/matiere/ajoutmatiere-traitement.php">
                <br>
                <h3 style="margin-bottom: 25px; text-align: center;">Ajout de matière</h3>
                <div class="form-group">
                    <input type="text" class="form-control" name="nom_matiere" placeholder="Matière" required>
                </div>
