...
<div class="offset-2 col-md-8 col-xs-2">
    <div class="form-area text-center">
        <form id="form-contact" method="POST" action="/pronote/traitement/direction/inscriptiondir-traitement.php">
            <br>
            <h3 style="margin-bottom: 25px; text-align: center;">Ajout direction</h3>
